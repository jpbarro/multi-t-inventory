...
PRODUCTS = [
    {"name": "Laptop Pro 15",       "description": "15-inch professional laptop",           "sku": "ELEC-LP15"},
    {"name": "Wireless Mouse",      "description": "Ergonomic wireless mouse",              "sku": "ELEC-WM01"},
    {"name": "USB-C Hub",           "description": "7-in-1 USB-C docking station",          "sku": "ELEC-HUB7"},
    {"name": "Mechanical Keyboard", "description": "RGB mechanical keyboard, Cherry MX",    "sku": "ELEC-KB01"},
    {"name": "Monitor 27\"",        "description": "27-inch 4K IPS monitor",                "sku": "ELEC-MN27"},
    {"name": "Webcam HD",           "description": "1080p HD webcam with microphone",       "sku": "ELEC-WC01"},
    {"name": "Standing Desk",       "description": "Electric height-adjustable desk",       "sku": "FURN-SD01"},
    {"name": "Office Chair",        "description": "Ergonomic mesh office chair",           "sku": "FURN-CH01"},
    {"name": "Desk Lamp",           "description": "LED desk lamp with adjustable arm",     "sku": "FURN-DL01"},
    {"name": "Notebook A5",         "description": "Hardcover A5 lined notebook",           "sku": "STAT-NB01"},
    {"name": "Ballpoint Pen Pack",  "description": "Pack of 12 black ballpoint pens",       "sku": "STAT-BP12"},
    {"name": "Whiteboard 90x60",    "description": "Magnetic whiteboard 90x60 cm",          "sku": "STAT-WB01"},
    {"name": "Ethernet Cable 3m",   "description": "Cat6 ethernet cable, 3 meters",        "sku": "NET-EC03"},
    {"name": "Wi-Fi Router",        "description": "Dual-band Wi-Fi 6 router",             "sku": "NET-WR06"},
    {"name": "Surge Protector",     "description": "6-outlet surge protector power strip",  "sku": "ELEC-SP06"},
]
